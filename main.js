document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "Shrutu"; // Replace with dynamic value
    ...
    noButton.addEventListener("click", function () {
        ...
        if (noClickCount < 5) {
            ...
            questionText.innerHTML += `<br><span class="no-choice-text">Did you really think you had a choice? You will be my valentine. 🤭</span>`;
        }
    });
